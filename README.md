...
A way to transmit data between parties as an object. It is verified by both parties.

- [ ] What steps can you take in your web apps to keep your data secure?

KISS, Keep it Secure and Simple. And don't trust every user. 

- [ ] Describe how web servers work.

They process incoming HTTP requests from users or clients, and deliver web pages back to them.
